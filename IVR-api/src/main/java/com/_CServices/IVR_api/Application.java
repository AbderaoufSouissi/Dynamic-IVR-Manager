...
public class Application {
	...
	CommandLineRunner initDb() {
		return args -> {
			RequestContext.setUserId(SYSTEM_ID);
			try{
				Set<Permissions> SYSTEM_PERMISSIONS = new HashSet<>();

				if(!userRepository.existsByUsername("SYSTEM_USER")){
					...
					var createUserPermission = permissionsRepository.save(CREATE_USER_PERMISSION);
					...
					var updateUserPermission = permissionsRepository.save(UPDATE_USER_PERMISSION);
					...
					var deleteUserPermission = permissionsRepository.save(DELETE_USER_PERMISSION);
