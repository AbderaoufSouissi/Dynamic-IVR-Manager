...
const HomePage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section className="min-h-[90vh] md:h-screen flex flex-col justify-center items-center text-center bg-gradient-to-br from-white via-blue-50/50 to-blue-50/30 relative overflow-hidden px-4 sm:px-6 lg:px-8 py-12 md:py-0">
          ...
          <div className="max-w-3xl mx-auto w-full">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-blue-900 bg-clip-text text-transparent leading-tight mb-4">
              Simplifiez la Gestion <br className="hidden md:block" />
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center items-center">
              ...
              <button
                ...
                className="inline-flex items-center justify-center border-2 border-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-xl hover:border-blue-600 hover:text-blue-600 transition-all duration-300 hover:bg-white hover:shadow-lg"
              >
        ...
        <section
          id="features-section"
          className="py-16 md:py-24 lg:min-h-screen flex flex-col justify-center bg-gradient-to-br from-gray-50 to-blue-50/50 px-4 sm:px-6 lg:px-8"
        >
          <div className="container mx-auto">
            <div className="text-center mb-10 md:mb-14 max-w-3xl mx-auto">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
              {features.map((feature, idx) => (
                <div
                  key={idx}
                  className="group bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col items-center text-center space-y-4 border border-gray-100/50 hover:border-blue-200 hover:-translate-y-2"
                >
